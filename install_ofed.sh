...
yum install rsync perl createrepo kernel-headers-$kernel_version python-devel pciutils lsof kernel-devel-$kernel_version redhat-rpm-config rpm-build gcc -y
